    ...
    return (
        <section className="flex justify-center ">
            ...
            <div className="max-w-7xl w-full">
                <div className="h-96">
                    <h1 className="text-8xl text-center font-extrabold mt-14 bg-clip-text bg-current p-4 text-transparent bg-gradient-to-r from-[#FFB534] to-[#65B741]">Icons</h1>
                ...
                <div className=" flex justify-center items-center">
                    ...
                    >
                        <div className="grid grid-cols-8 max-sm:grid-cols-1 max-md:grid-cols-2 max-lg:grid-cols-3 gap-10 mx-5 my-2">
                            ...
                            {fruitsData.slice(0, visibleCards).map((row, rowIndex) => (
                                ...
                                >
                                    ...
                                    {row.map((color, colIndex) => (
                                        <span
                                            key={colIndex}
                                            className={`w-full h-24 grid grid-cols-8 text-white sh bold-${color}`}
                                        >
