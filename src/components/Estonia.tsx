...
export default function Estonia() {
    return (
        <section className="">
            <section className="grid grid-cols-2 gap-1 m-5 h-full">
                <div className="mt-0">
                    <div className="text-4xl">
                        <h1 className="text-6xl leading-tight font-extrabold my-7 bg-clip-text text-transparent bg-gradient-to-r from-[#6944ff] to-[#e11d48]">
                            Empower, business, API
                        </h1>
                        <h1 className="font-bold">your business with API</h1>
                        <h1 className="text-lg mt-7 font-normal">your business with API from Rusumat your business with API from Rusumat your business with API from Rusumat</h1>
                    </div>
                </div>
                <div className=" ">
                    <Image
            ...
            <div className="grid grid-cols-4 gap-10 m-10 mt-16 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1">
